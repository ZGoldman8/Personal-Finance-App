...
public class PersonalFinanceDatabase extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_ASSET_ALLOCATION_ID = "ASSET_ALLOCATION_ID";
    ...
    public static final String COLUMN_ASSETS_ID = "ASSETS_ID";
    public static final String COLUMN_ASSETS_401k = "ASSETS_401k";
    public static final String COLUMN_ASSETS_HSA = "ASSETS_HSA";

    public static final String COLUMN_ASSETS_INVENTORY_ID = "ASSETS_INVENTORY_ID";
    ...
    public static final String COLUMN_NET_WORTH_ID = "NET_WORTH_ID";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createAssetAllocationTableStatement = "CREATE TABLE " + ASSET_ALLOCATION_TABLE + " (" +
                COLUMN_ASSET_ALLOCATION_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        String createAssetsTableStatement = "CREATE TABLE " + ASSETS_TABLE + " (" +
                ...
                COLUMN_ASSETS_INVENTORY_ID + " INT," +
                COLUMN_NET_WORTH_ID + "INT, " +
                //" FOREIGN KEY (" + COLUMN_NET_WORTH_ID  + ") REFERENCES " + NET_WORTH_TABLE + "(" + COLUMN_NET_WORTH_ID + "), " +
                " FOREIGN KEY (" + COLUMN_ASSETS_INVENTORY_ID  + ") REFERENCES " + ASSETS_INVENTORY_TABLE + "(" + COLUMN_ASSETS_INVENTORY_ID + "), " +
                " FOREIGN KEY (" + COLUMN_NET_WORTH_ID  + ") REFERENCES " + NET_WORTH_TABLE + "(" + COLUMN_NET_WORTH_ID +
                "))";

        String createAssetsInventoryTableStatement = "CREATE TABLE " + ASSETS_INVENTORY_TABLE + " (" +
                COLUMN_ASSETS_INVENTORY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        String createPortfolioTableStatement = "CREATE TABLE " + PORTFOLIO_TABLE + " (" +
                ...
                COLUMN_ASSET_ALLOCATION_ID + " INT, " +
                " FOREIGN KEY (" + COLUMN_ASSET_ALLOCATION_ID  + ") REFERENCES " + ASSET_ALLOCATION_TABLE + "(" + COLUMN_ASSET_ALLOCATION_ID +
                "))";
